...
public class TabHoaDon extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btnXuatFileCTHD = new javax.swing.JButton();
        ...
        btnXuatFileCTHD.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        btnXuatFileCTHD.setText("Xuất File PDF");
        btnXuatFileCTHD.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnXuatFileCTHDActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(kGradientPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, 1136, Short.MAX_VALUE)
        );
    ...
    private void btnXuatFileCTHDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatFileCTHDActionPerformed
        // TODO add your handling code here:
        String path = "";
        ...
        try {
            PdfWriter.getInstance(doc, new FileOutputStream(path + "CTHD.pdf"));
            doc.open();
            ...
            for (int i = 0; i < tblChiTietHoaDon.getRowCount(); i++) {
                ...
                String STT = tblChiTietHoaDon.getValueAt(i, 0).toString();
                String SoHD = tblChiTietHoaDon.getValueAt(i, 1).toString();
                String MaSanPham = tblChiTietHoaDon.getValueAt(i, 2).toString();
                String SoLuong = tblChiTietHoaDon.getValueAt(i, 3).toString();
                String GhiChu = tblChiTietHoaDon.getValueAt(i, 4).toString();
                //String Gia = tblChiTietHoaDon.getValueAt(i, 5).toString();
                //String GhiChu = tblHoaDon.getValueAt(i, 6).toString();

                 tbl.addCell(STT);
                 tbl.addCell(SoHD);
                 tbl.addCell(MaSanPham);
                 tbl.addCell(SoLuong);
                 tbl.addCell(GhiChu);
                 //tbl.addCell(Gia);
               //  tbl.addCell(GhiChu);
            ...
            Logger.getLogger(TabHoaDon.class.getName()).log(Level.SEVERE, null, ex);
    ...
    }//GEN-LAST:event_btnXuatFileCTHDActionPerformed
    ...
    private javax.swing.JButton btnXuatFileCTHD;
