...
public class TabKhachHang extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDanhSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã Khách Hàng", "Họ Tên", "Giới Tính", "Địa Chỉ", "Số Điện Thoại", "Ngày Sinh", "Email"
            }
        ));
    ...
    private void tblDanhSachMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDanhSachMouseClicked
        ...
        KhachHang nv = BLLKhachHang.LayNhanVienTheoMa(MaKH);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        Date NgaySinh = txt_Date.getDate();
        String Email = txtEmail.getText();
        if (this.txtMaKH.getText().length() == 0) {
            ThongBao.ThongBaoSQL("Thông Báo", "Bạn Chưa Chọn Dòng Để Sửa ");
        } else {
            KhachHang KH = new KhachHang(MaKhachHang, HoTen, GioiTinh, DiaChi, SDT, NgaySinh, Email);
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        if (this.txtTimKiem.getText().length() == 0) {
            ...
            txtTimKiem.setText("Có " + tblDanhSach.getRowCount() + "Tên Khách Hàng Cần Tìm");
